...
def UNetPPL(input_height=INPUT_HEIGHT, input_width=INPUT_WIDTH, input_channels=INP_CHANNELS):
    ...
    unetppl_output = Conv2D(1, (1, 1), activation='sigmoid', kernel_initializer = 'he_normal', padding='same')(deconv1)

    model = Model([inputs], [unetppl_output], 'UNetPPL')
    return model
