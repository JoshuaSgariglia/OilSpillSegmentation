...
def UNetPP(input_height=INPUT_HEIGHT, input_width=INPUT_WIDTH, input_channels=INP_CHANNELS, dropout_rate=DROPOUT_RATE):
    ...
    dense1_3 = Dropout(dropout_rate) (dense1_3)
    dense1_3 = Conv2D(32, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same') (dense1_3)
    dense1_3 = Dropout(dropout_rate) (dense1_3)
    ...
    dense2_2 = Dropout(dropout_rate) (dense2_2)
    dense2_2 = Conv2D(64, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same') (dense2_2)
    dense2_2 = Dropout(dropout_rate) (dense2_2)
    ...
    dense3_1 = Dropout(dropout_rate) (dense3_1)
    dense3_1 = Conv2D(128, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same') (dense3_1)
    dense3_1 = Dropout(dropout_rate) (dense3_1)
    ...
    model = Model(inputs=[inputs], outputs=[outputs], name='UNetPP')
    return model
